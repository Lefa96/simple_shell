 ...
 * Return: 0 if no num in the string, converted num otherwise
 *       -1 on error
 */
int _erratoi(char *s)
{
	...
	if (*s == '+')
		s++;  /* TODO: Why does this make the main return 255? */
	for (i = 0;  s[i] != '\0'; i++)
	{
		if (s[i] >= '0' && s[i] <= '9')
		{
 ...
 * @buf: the address of a string to modify
 *
 * Return: Always 0;
 */
